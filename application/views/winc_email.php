                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="padding:40px;"><img
                                                        src="http://cms-p2-ge.reflexwall.com.au/images/EDM/edm_top_logo_1.png"
                                                        width="142" height="52" border="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 0px 30px 0px 30px;"><img
                                                        src="http://cms-p2-ge.reflexwall.com.au/images/EDM/mobile_top_copy_1.png"
                                        ...
                                        <tr>
                                            <td style="text-align:center;" class="padding">
                                                <a href="<?php echo $cmsHomeUrl; ?>trackit/showcontent/<?php echo $accessCode; ?>"
                                                   target="_blank"><img
                                                            src="http://cms-p2-ge.reflexwall.com.au/framework/uploads/<?php echo $fileName; ?>"
                            ...
                            <tr>
                                <td align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td background="http://cms-p2-ge.reflexwall.com.au/images/EDM/edm_bg_1.png"
                                                bgcolor="#161f56" valign="top"
                                                style="padding:10px 40px 110px;text-align:center;background-color:#161f56;background: #161f56 url(http://cms-p2-ge.reflexwall.com.au/images/EDM/edm_bg.png) no-repeat bottom right;background-size: 600px 220px;">
                                                <!--[if gte mso 9]>
                                                ...
                                                <div>
                                                    <a href="<?php echo $cmsHomeUrl; ?>trackit/showcontent/<?php echo $accessCode; ?>"
                                                       target="_blank"><img
                                                                src="http://cms-p2-ge.reflexwall.com.au/images/EDM/edm_btn_share_1.png"
                            ...
                            <tr>
                                <td align="center" style="background-color:#ffffff;padding:20px 0px 20px 0px;"><img
                                            src="http://cms-p2-ge.reflexwall.com.au/images/EDM/edm_winc_bottom_logo_1.png" width="600"
