                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="padding:40px;"><img
                                                        src="http://www.reflexwall.com.au/images/EDM/edm_top_logo.png"
                                                        width="142" height="52" border="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding: 0px 30px 0px 30px;"><img
                                                        src="http://www.reflexwall.com.au/images/EDM/mobile_top_copy.png"
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="padding: 40px; font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #ffffff;"
                                                ...
                                                <p>We've captured you in action you can share it with your mate for
                                                    bragging right.</p>
                                                <p>Don't forget to hashtag #reflexwall on your social posts!</p>
                                                <p>Go the mighty Roosters.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td style="text-align:center;" class="padding">
                                                <a href="<?php echo $cmsHomeUrl; ?>trackit/showcontent/<?php echo $accessCode; ?>"
                                                   target="_blank"><img
                                                            src="http://www.reflexwall.com.au/framework/uploads/<?php echo $fileName; ?>"
                            ...
                            <tr>
                                <td align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td background="http://www.reflexwall.com.au/images/EDM/edm_bg.png"
                                                bgcolor="#161f56" valign="top"
                                                style="padding:10px 40px 110px;text-align:center;background-color:#161f56;background: #161f56 url(http://www.reflexwall.com.au/images/EDM/edm_bg.png) no-repeat bottom right;background-size: 600px 220px;">
                                                <!--[if gte mso 9]>
                                                <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true"
                                                        stroke="false" style="mso-width-percent:1000;">
                                                    <v:fill type="tile"
                                                            src="http://www.reflexwall.com.au/images/EDM/edm_bg.png"
                                                ...
                                                <div>
                                                    <a href="<?php echo $cmsHomeUrl; ?>trackit/showcontent/<?php echo $accessCode; ?>"
                                                       target="_blank"><img
                                                                src="http://www.reflexwall.com.au/images/EDM/edm_btn_share.png"
                            ...
                            <tr>
                                <td align="center" style="background-color:#ffffff;padding:20px 0px 20px 0px;"><img
                                            src="http://www.reflexwall.com.au/images/EDM/edm_bottom_logo.png" width="64"
                                            height="74" style="width:64px;height:74px;"/></td>
                            </tr>
                        </table>
                    </td>
                </tr>
