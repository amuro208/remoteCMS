...
class Upload_tests_4_aia extends Base_tests
{
  private $url;
  private $utils;
  ...
  function test_fp(){
    ...
    $fileData = "C:/PROJECT/AIA/VirtualKick/fileName00.png";
    $params["FileData00"] = new CURLFile($fileData,"image/png","fileName00.png");
...
*/
  ...
  function test_vk(){
    ...
    $params["photoId"] = "user1_1458525384064,user2_1458525384064";
