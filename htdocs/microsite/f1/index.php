  ...
  <div id="wrapper">
    <section>
      ...
      <div class="sharebutton">
        ...
        <!--Facebook Upload-->
        <!--
        <a href="<?php echo $frameurl;?>/facebook/auto2callback/?acode=<?php echo $accessCode;?>" id="facebook">Facebook Post</a>
        -->
        ...
        <!--Instagram Share-->
        <a href="http://www.f1forreal.com.au/instagram.php?acode=<?php echo $accessCode;?>" id="instagram">
      ...
      <div class="sharebutton">
        <!--Download-->
        <a href="<?php echo $downloadurl;?>" id="download" target="download_frame"><img src="./img/btn_download.png"/></a>
      </div>
      <div class="banner">
        <a href="<?php echo $frameurl;?>/trackit/clickedmlink2/4/<?php echo $accessCode;?>" target="about:blank"><img id="banner" src="img/gr_f1logo.png"></a>
        <div class="sponsor">
