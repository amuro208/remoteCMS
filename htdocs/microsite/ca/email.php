                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><img src="http://youunlimited360cam.com/img/edm/header.png" width="600" height="200" border="0" alt="F1 For Real Header" style="display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; font-size: 16px;" class="img-max">
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td style="text-align:center;" class="padding">
                            <img src="http://placehold.it/600x338/" class='img-max'>
                          </td>
                        </tr>
                      </table>
                    </td>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" class="responsive-table">
                              <tr>
                                <td align="center" style="padding:20px 0px">
                                  <a href="<?php echo $cmsHomeUrl;?>trackit/clickedmlink2/2/<?php echo $accessCode;?>" target="_blank" class="mobile-button" style="margin:0px 0px 0px 0px"><img src="http://youunlimited360cam.com/img/edm/btn_clickhere.png" class="img-ninty"></a>
                                </td>
                              </tr> 
                              <tr>
